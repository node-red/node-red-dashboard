...
function UiCompile(t,e){return function(i,n,o){var l=e.$new();i.$watch("me.item.msg",function(t){l.msg=t}),i.$watch(function(t){return t.$eval(o.uiCompile)},function(e){n.html(e),t(n.contents())(l)})}}function UiComponent(t,e,i,n){var o={};return{restrict:"E",bindToController:{item:"="},controller:ControlController,controllerAs:"me",scope:!0,link:function(l,m,u,a){var r=o[a.item.type];if(!r){var c="templates/controls/"+a.item.type+".html",h=i.get(c);r=h?n.when(h):t.get(c).then(function(t){return t.data}),o[a.item.type]=r}r.then(function(t){var i=angular.element(t);a.item.width&&i.attr("flex",a.item.width),m.replaceWith(e(i)(l))}),a.init()}}}function ControlController(t,e){this.init=function(){switch(this.item.type){case"numeric":this.item.getText=e(this.item.format||"{{value}}").bind(null,this.item);break;case"text":this.item.getText=e(this.item.format||"{{payload}}").bind(null,this.item)}},this.buttonClick=function(t){t&&(this.item.value=t),this.valueChanged(0)},this.valueChanged=function(t){n({id:this.item.id,value:this.item.value},"number"==typeof t?t:200)},this.valueDown=function(){this.item.value>this.item.min&&(this.item.value--,this.valueChanged(0))},this.valueUp=function(){this.item.value<this.item.max&&(this.item.value++,this.valueChanged(0))};var i,n=function(e,n){return 0===n?void t.emit(e):(i&&clearTimeout(i),void(i=setTimeout(function(){i=void 0,t.emit(e)},n)))}}angular.module("ui").directive("uiComponent",UiComponent).directive("uiCompile",UiCompile),UiCompile.$inject=["$compile","$rootScope"],UiComponent.$inject=["$http","$compile","$templateCache","$q"],ControlController.$inject=["WebEvents","$interpolate"];
angular.module("ui").run(["$templateCache",function(n){n.put("templates/cards.html",'<md-toolbar class="md-whiteframe-z1">\r\n    <div class="md-toolbar-tools">\r\n        <md-button ng-click="main.toggleSidenav()" class="md-icon-button">\r\n            <ng-md-icon icon="menu"></ng-md-icon>\r\n        </md-button>\r\n        <h1 ng-show="main.loaded">{{main.selectedTab.header}}</h1>\r\n    </div>\r\n</md-toolbar>\r\n<md-content layout="row" flex>\r\n    <md-sidenav layout="column" class="md-sidenav-left md-whiteframe-z1"\r\n                md-component-id="left">\r\n        <md-list>\r\n            <md-subheader class="md-no-sticky">Pages</md-subheader>\r\n            <md-list-item ng-repeat="tab in main.tabs" ng-click="main.select($index)">\r\n                <ng-md-icon class="md-default-theme" icon="{{tab.icon}}" style="margin: 5px"></ng-md-icon>\r\n                <p>{{tab.header}}</p>\r\n            </md-list-item>\r\n            <md-subheader class="md-no-sticky">Other</md-subheader>\r\n            <md-list-item ng-click="main.openEditor()">\r\n                <ng-md-icon icon="open_in_browser" style="margin: 5px"></ng-md-icon>\r\n                <p>Edit flows</p>\r\n            </md-list-item>\r\n        </md-list>\r\n    </md-sidenav>\r\n\r\n    <md-content layout="column" flex>\r\n        <md-content layout="row" layout-align="center start" layout-wrap>\r\n            <md-card ng-repeat="group in main.selectedTab.items" flex class="group-card">\r\n                <md-card-content layout="column">\r\n                    <h2 ng-show="group.header" class="md-title">{{group.header}}</h2>\r\n                    <div ng-repeat="control in group.items" flex>\r\n                        <ui-component item="control"></ui-component>\r\n                        <md-divider ng-if="!$last"></md-divider>\r\n                    </div>\r\n                </md-card-content>\r\n            </md-card>\r\n        </md-content>\r\n    </md-content>\r\n</md-content>'),n.put("templates/controls/button-row.html",'<div flex layout="row" layout-align="space-around center">\r\n    <md-button ng-repeat="button in me.item.buttons" class="md-icon-button" ng-click="me.buttonClick(button.payload)" aria-label="unknown">\r\n        <ng-md-icon icon="{{button.icon}}"></ng-md-icon>\r\n    </md-button>\r\n</div>'),n.put("templates/controls/button.html",'<md-button class="md-raised" ng-click="me.buttonClick()" aria-label="{{me.item.label}}">{{me.item.label}}</md-button>'),n.put("templates/controls/color.html",'<div flex layout="row" layout-align="space-between center">\r\n    <p>{{me.item.label}}</p>\r\n    <p>TODO...</p>\r\n</div>\r\n\r\n\r\n\r\n\r\n'),n.put("templates/controls/numeric.html",'<div flex layout="row" layout-align="space-between center">\r\n    <p>{{me.item.label}}</p>\r\n    <div layout="row" layout-align="center center">\r\n        <md-button class="md-icon-button" ng-click="me.valueDown()" aria-label="{{me.item.label}}">\r\n            <ng-md-icon icon="expand_more"></ng-md-icon>\r\n        </md-button>\r\n        <h3 ng-bind-html="me.item.getText()"></h3>\r\n        <md-button class="md-icon-button" ng-click="me.valueUp()" aria-label="{{me.item.label}}">\r\n            <ng-md-icon icon="expand_less"></ng-md-icon>\r\n        </md-button>\r\n    </div>\r\n</div>'),n.put("templates/controls/paragraph.html",'<div flex>\r\n    <p ui-compile="me.item.format"></p>\r\n</div>\r\n'),n.put("templates/controls/slider.html",'<div flex layout="row" layout-align="space-between center">\r\n    <p>{{me.item.label}}</p>\r\n    <md-slider flex="60" min="{{me.item.min}}" max="{{me.item.max}}"\r\n            ng-model="me.item.value" aria-label="{{me.item.label}}"\r\n            ng-change="me.valueChanged()"/>\r\n</div>'),n.put("templates/controls/switch.html",'<div flex layout="row" layout-align="space-between center">\r\n    <p>{{me.item.label}}</p>\r\n    <md-switch ng-model="me.item.value" ng-change="me.valueChanged(0)" aria-label="{{me.item.label}}">\r\n	</md-switch>\r\n</div>\r\n\r\n'),n.put("templates/controls/text.html",'<div flex layout="row" layout-align="space-between center">\r\n    <p>{{me.item.label}}</p>\r\n	<h4 ng-bind-html="me.item.getText()"></h4>\r\n</div>\r\n')}]);